...
1.4  What is build
1.5  Building with zlib1.2.3 (or 1.2.5) and expat 2.0.1 and curl-7.30.0
1.6  Express editions of Visual Studio (or 32 bit only builds, or 64 bit only builds)
1.7  Support for Visual Studio 2012 (DevStudio 11)
...
1.5  Building with zlib1.2.5 (or 1.2.3) and/or expat 2.0.1 and/or other versions of curl
     By default, msvc64 builds with zlib-1.2.7, expat 2.1.0 and curl-7.30.0
...
1.6  Express editions of Visual Studio (or 32 bit only builds, or 64 bit only builds)
     Visual Studio 2008 Express did not provide a 64 bit compiler.
...
1.7  Support for Visual Studio 11
     I have successfully built and tested a sub-set of exiv2/msvc64 with Visual Studio 11 beta.
     
     I have no plan to support beta versions of Visual Studio.
     I plan to support Visual Studio 2012 Express when time permits.

2    Design

     expat and zlib1.2.5 (and earlier) and curl-7.30.0 do not provide 64 bit builds for Visual Studio.
     ...
     zlib, expat and curl
     exiv2\msvc64\zlib\zlib.vcproj                          Visual Studio files
     ..\..\..\zlib-1.2.7\                                   Source code

     exiv2\msvc64\expat\expat.vcproj                        Visual Studio files
     ..\..\..\expat-2.1.0\                                  Source code

     exiv2\msvc64\curl\curl.vcproj                          Visual Studio files
     ..\..\..\curl-7.30.0\                                  Source code
...
2.2  Relationship with msvc build environment
     ...
     4) msvc64 supports Visual Studio 2005, 2008 and 2010 (no support for 2003)
     ...
     msvc will continue to be supported for 32 bit builds using Visual Studio 2003/05/08,
...
4.3  runner.py
     ...
     This script is a relic from the days before I discovered (thanks to Volker) how to run
     the bash test suite using Cygwin on the msvc64 builds.  You may find it useful.
