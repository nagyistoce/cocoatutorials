...
function start() {
	...
	function onRequest(request, response) {
		...
		if (pathname != "/favicon.ico") _mylog.log("\nREQUEST TO " + pathname, true);
	...
	_mylog.log("Server has started at port " + port, true);
}


function restart() {
	if (serverInstance != "") {
		_mylog.log("Server has closed", true);
