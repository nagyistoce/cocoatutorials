...
var ContentFlowItem  = function (CFobj, element, index) {
    ...
    if ($CF(element).nodeName == "IMG") {
		...
		// this is obsolete code which dealt with FullSize
        // var sLongdesc = 'longdesc';
		// var aLongdesc = $CF(element).getAttribute(sLongdesc); 
        // if (aLongdesc )	el.setAttribute(sLongdesc,aLongdesc);
		// console.log(sLongdesc + ' = ' + aLongdesc) ;
...
ContentFlow.prototype = {
    ...
    _defaultConf: { 
        ...
        keys: {
            13: function () { this.conf.enterKey(this._activeItem) },
            27: function () { this.conf.escKey(this._activeItem) },
            32: function () { this.conf.spaceKey(this._activeItem) },
        ...
        onInit: function () {},
        escKey: function (item) {},
        enterKey: function (item) {},
        spaceKey: function (item) {},
